...
import ro.learnstuff.threading.FindClass;
...
public class ThreadsMain {
	...
	public static void main(String[] args) {
		...
		FindClass system = new FindClass("C:\\Windows");
		FindClass programFiles = new FindClass("C:\\Program Files");
		FindClass documents = new FindClass("C:\\Documents And Settings");
